...
**APIs.json:** [https://raw.githubusercontent.com/api-evangelist/argo-cd/refs/heads/main/apis.yml](https://raw.githubusercontent.com/api-evangelist/argo-cd/refs/heads/main/apis.yml)
...
- [OpenAPI](openapi/argo-cd-openapi.json) — [OpenAPI Specification](https://spec.openapis.org/oas/latest.html)
...
- [API Reference](https://cd.apps.argoproj.io/swagger-ui)
...
- [C L I](https://argo-cd.readthedocs.io/en/stable/user-guide/commands/argocd/)
- [SDK](https://github.com/argoproj/argo-cd/tree/master/pkg/apiclient)
- [Support](https://github.com/argoproj/argo-cd/issues)
- [Spectral Rules](rules/argo-cd-spectral-rules.yml)
- [Vocabulary](vocabulary/argo-cd-vocabulary.yaml)
- [Features](undefined)
- [Use Cases](undefined)
